...
/**
 * Die Ersetzungsregeln eines {@link solutions.ws13.assignment3.solutions.ws13.assignment3.lsystem.LindenmayerSystem}.
 *
...
public class Rules {
    ...
    public void printRules(){
    	for (Map.Entry<String, String> e : drawingRules.entrySet() ){
    		System.out.println( "Symbol/Replace : " + e.getKey() + " / " + e.getValue() );
    	}
    	for (Map.Entry<String, String> f : replacementRules.entrySet() ){
    		System.out.println( "Symbol/Replace : " + f.getKey() + " / " + f.getValue() );
    	}
